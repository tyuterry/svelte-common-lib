...
<button on:click={editor?.chain()?.focus()?.addColumnBefore()?.run}>
	<FaLayers style="overflow:hidden">
		...
		<Fa icon={faSquareFull} class="mask" scale={0.6} translateX={0.36} />
		<Fa icon={faSquareFull} class="mask" translateX={0.72} />
...
<button on:click={editor?.chain()?.focus()?.addRowAfter()?.run}>
	<FaLayers style="overflow:hidden">
		...
		<Fa icon={faSquareFull} class="mask" scale={0.6} translateY={-0.36} rotate="90" />
		<Fa icon={faSquareFull} class="mask" translateY={-0.72} />
...
<button on:click={editor?.chain()?.focus()?.deleteColumn()?.run}>
	<FaLayers style="overflow:hidden">
		...
		<Fa icon={faSquareFull} class="mask" translateX={0.75} />
		<Fa icon={faSquareFull} class="mask" scale={0.4} translateX={-0.2} />
...
<button on:click={editor?.chain()?.focus()?.deleteRow()?.run}>
	<FaLayers style="overflow:hidden">
		...
		<Fa icon={faSquareFull} class="mask" translateY={-0.75} />
		<Fa icon={faSquareFull} class="mask" scale={0.4} translateY={0.2} />
...
<button on:click={editor?.chain()?.focus()?.deleteTable()?.run}>
	<FaLayers style="overflow:hidden">
		<Fa icon={faTable} />
		<Fa icon={faSquareFull} class="mask" scale={0.4} translateY={0.05} />
